  ...
  return (
    <View style={styles.container}>
        ...
        <View>
          <View style={styles.headerContainer}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Profile')} style={styles.profileImg}>
              ...
              {profileImage ? (
                ...
                <Image
                  source={require('../../images/User.png')} // Default image if profileImage is not available
                  style={{tintColor: THEME_COLOR}} // Apply theme color tint to the default image
                  resizeMode="contain"
                />
              )}
            </TouchableOpacity>
          ...
          <View
            ...
            <Text
              style={[
                styles.good,
                {color: 'lightgreen', fontWeight: '600', fontSize: 20},
              ]}>
              {name}
            </Text>
          </View>
          <View style={styles.searchView}>
            <TouchableOpacity style={styles.searchInput}>
              ...
              {searchQuery.length > 0 && (
                <TouchableOpacity
                  onPress={() => setSearchQuery('')} // Clear the search input when the cross is pressed
        ...
        <View>
          <View style={styles.headerContainer}>
            ...
            <TouchableOpacity
              ...
              style={styles.profileImg}>
              {console.log('profileImsg', profileImage)}
              {profileImage ? (
                <Image
                  source={{uri: profileImage}}
                  style={styles.profileImg}
      ...
      <View style={styles.exploreContainer}>
        ...
        <Text style={[styles.Explore, {color: THEME_COLOR2}]}> See All</Text>
      </View>
